...
# Boy Event
RIGHT_DOWN, LEFT_DOWN, RIGHT_UP, LEFT_UP, SLEEP_TIMER, SPACE, LEFT_UP_SHIFT, RIGHT_UP_SHIFT, LEFT_DOWN_SHIFT\
    , RIGHT_DOWN_SHIFT, DASH_TIMER = range(11)
...
key_event_table = {
    ...
    (SDL_KEYDOWN, SDLK_LSHIFT): LEFT_DOWN_SHIFT,
    (SDL_KEYDOWN, SDLK_RSHIFT): RIGHT_DOWN_SHIFT,
    (SDL_KEYUP, SDLK_LSHIFT): LEFT_UP_SHIFT,
    (SDL_KEYUP, SDLK_RSHIFT): RIGHT_UP_SHIFT
}
